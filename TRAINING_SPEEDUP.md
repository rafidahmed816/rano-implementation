...
python train_stage2.py --librispeech_root "D:\thesis\rano-implementation\data\LibriSpeech" --librispeech_subsets train-clean-100 --acg_checkpoint checkpoints/acg/acg_best.pt --output_dir checkpoints/rano --log_dir logs/rano --iterations 200000 --batch_size 4 --accumulate_steps 4 --lr 1e-5 --val_every 500 --amp
