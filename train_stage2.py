"""Stage 2: Train Rano anonymizer with pre-trained (frozen) ACG (Sec. III-E, Alg. 1)."""
...
def train_rano(args):
    ...
    # Load pre-trained ACG and freeze it
    ...
    # Load pre-trained ASV and freeze it
...
if __name__ == "__main__":
    ...
    p.add_argument("--num_cinn_blocks", type=int, default=8)
    ...
    p.add_argument("--distance_threshold", type=float, default=0.3)
